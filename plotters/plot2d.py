...
Edit 2022-10-04: JE: Stripping out data, whole new set of functions for flexible processing of data
                     In addition, general cleanup
"""
...
class Image:
    def __init__(self,filename) -> None:
        ...
        return
    class Var:
        def __init__(self,var_name,symbol,units,cmap,extent,data) -> None:
    ...
    def read_data(self,filename):
        ...
        # Get cell volume
        self.cell_vol = self.x_space * self.y_space
        ...
        self.radius = self.Var("Radius",
                               ...
                               "blues",extent,
                               radius)
        self.heat   = self.Var("Radiogenic heating",
                           r"$\mathcal{Q}$",
...
def plot_split(ax,data,col,plot_std=True,plot_maxmin=True):
    """
...
class Desiccation:
    ...
    def generate_img(self,t):
        ...
        return img
    def plot_current_desiccation(self,ax):
        ax.imshow(self.last_img)
        return ax
    def plot_desiccation_times(self,ax):
        ax.imshow(self.vap)
