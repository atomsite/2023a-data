        ...
        for fe60_abun in fe60_range:
          ...
          # Get a name for the working directory
            ...
            for grain in args.grains:
              work_dir = "sim_p_{:.2f}_c_{:.2f}_al_{:.2f}_fe_{:.2f}_gr_{:.2f}".format(
                planetoid_size,
                core_ratio,
                al26_abun,
                fe60_abun,
              ...
              simsetup.gen_sim(planetoid_size,
                            ...
                            args.init_time,
                            work_dir,
                            grain_volume_frac=grain)
              simsetup.write_yaml(work_dir,planetoid_size,core_ratio,al26_abun,fe60_abun,args.exit_time,args.init_time,grain_volume_frac=grain)
              nsims += 1
...
if __name__ == "__main__":
  ...
  parse.add_argument("-f","--exit_time",type=float,help="Initialisation time (yr)",default=21.0e6)
  parse.add_argument("-g","--grains",nargs="+",type=float,help="Volume fraction of Fe grains in mantle",default=None)
